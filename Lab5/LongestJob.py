...
def longestJob(listOfJobs):
    
    longest = listOfJobs[0].length
...
def longestAlgorithm(listOfJobs, waitingTimeArr, serviceTimeArr):

    orderedJobs = []
    
    i = 0
    while(i < 100):
        orderedJobs.append(listOfJobs.pop(longestJob(listOfJobs)))
        i+=1
